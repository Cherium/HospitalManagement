...
/**
 * MVC Model: Model that deals with the Create Nurse functionality, interacts as
...
public class CreateNewNurseModel extends UserSuperClass {
	...
	/**
	 * return the list of doctor names currently in the database, as a String array
