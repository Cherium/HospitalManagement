 ...
 */
public class EditReceptionistView extends JDialog {
	/*
	 ...
	 */
	public EditReceptionistView(String title) {
...
//Inner Panels	
		...
		// Add components to panel in order
		buttonPanel.add(editScheduleButton, "gapleft 50"); // in the current column, place the component with a gap of
															// 50px from the left
		buttonPanel.add(editScheduleButton, ""); // place the next component in the second column
		buttonPanel.add(editInformationButton, "gapleft 100"); // in the current column, place the component with a gap
																// of 100px from the left
