...
public class CreateNewPatientView extends JDialog {
	...
	public void initializeGUI() {
		...
		contentPanel = new JPanel(new MigLayout("wrap 2", "[align right] 16 [align left]")); // initialize jpanel and
																								// set its layout
		...
		contentPanel.add(year, "sg b, split"); // split splits a current column into 2. Everything in 'sgroup b' will be
												// the same size
