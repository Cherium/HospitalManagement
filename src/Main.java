...
public class Main {
	...
	/**
	 * Global variable; The Main Database that is available in all classes. Usage:
	 * 'Main.dbase' is used to access the object that represents the HashMap
	 * database. ex. 'Main.dbase.containsKey()' checks the HashMap to see if a key
