...
public class AdminController {
	...
	public void initListeners() {
		...
		// send the role selected in the list of the view class to the model class for
		// processing
		view.getCrtAccount().addActionListener(
				e -> model.createAccount(view.getRolesDropDown().getItemAt(view.getRolesDropDown().getSelectedIndex()) // handle
																														// 'create
																														// account
																														// button
																														// pressed'
		...
		view.getEditAccount().addActionListener(
				e -> model.editAccount(view.getRolesDropDown().getItemAt(view.getRolesDropDown().getSelectedIndex()) // handle
																														// 'edit
																														// account
																														// button
																														// pressed'
	...
	/**
	 * 
	 * Try to create a new department in the internal database and provide a
	 * success/fail dialog to user
	 * 
	 * @author Sajid C
	 * 
	 */
