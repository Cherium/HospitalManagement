...
/**
 * MVC Model: Controller that deals with the Create Nurse functionality,
 * interacts with model and view to help create an nurse.
 * 
 * @author Jeremy Fan
 */
...
public class CreateNewNurseController {
	...
	/**
	 * from view, get the doctor drop down and create two combo boxes that have a
	 * list of the doctors and the departments
	 * 
	 * @author Jeremy F
	 */
	 ...
	 * case, add an action to the "create button" and "add doctor" button.
	 * 
	...
	public void parseEntry() {
		...
		model.setDepartment(view.getDepartmentDropDown().getItemAt(view.getDepartmentDropDown().getSelectedIndex()));
