...
////////////////////////////////////////////////////
	...
	public void initializeButtonsSchedule(TemporalField fieldISO) {
		...
		*/		
		...
		JButton todaySelecter = new JButton("Today");
			btnPaneSchedule.add(todaySelecter);
		...
		todaySelecter.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				//for monthly view 
