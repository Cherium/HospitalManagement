...
public class CreateNewDoctorView extends JDialog {
	 ...
	 * inputs, password inputs, three buttons for creating, cancelling the creation
	 * process, and adding a nurse two combo boxes for nurse dropdowns and
	 * department dropdowns and a box.
	 */
...
//Inner Panels	
		...
		contentPanel.add(box, "span 3 2, center, height 50:150:, wrap"); // stretch the box across 3 horizontal columns
																			// and 2 vertical rows starting in the
																			// current row, set its height, and wrap to
																			// next row
