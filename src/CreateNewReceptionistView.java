 ...
 */
public class CreateNewReceptionistView extends JDialog {
	/*
	 ...
	 * process, and adding a doctor two combo boxes for doctor dropdowns and
	 ...
	 */
	public CreateNewReceptionistView(String title) {
...
//Inner Panels	
	...
	/**
	 * disable the nurse selection option for when the ER department is chosen by
	 * the User
	 * 
	 * @author Sajid C, Jeremy F
	 */
