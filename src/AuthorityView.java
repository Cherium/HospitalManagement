...
public class AuthorityView extends JFrame {
	 ...
	 * 
	 * @author Neil M #TODO Organize the java labels in a different fashion. Change
	 *         names
	 */
	public void initializeGUI() {
		...
		contentPanel = new JPanel(new MigLayout("align 50% 50%, wrap 2", "[align right] 16 [align left]")); // initialize
																											// jpanel
																											// and set
																											// its
																											// layout
