...
public class PatientView extends JFrame {
	...
	private ArrayList<JTextField> infoFields = new ArrayList<>(5); // add all JTextFields into an Array to add listeners
																	// later
...
//Inner Panels
		...
		infoPanel.setMinimumSize(new Dimension(450, 50)); // extends jpanel in this sg to have 1/2 the width of booking
															// panel
		...
		infoPanel.add(year, "sg b, split"); // split splits a current column into 2. Everything in 'sgroup b' will be
											// the same size
		...
		bookPanel.add(dayfw, "sg c, span, pushx, wrap"); // span final column to edge of JPanel and push to extend
															// column all the way to edge
	...
	public String getBirthday() {
		return (String) year.getSelectedItem() + "-" + (String) month.getSelectedItem() + "-"
