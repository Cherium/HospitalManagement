...
public class CreateNewDoctorModel extends UserSuperClass {
	 ...
	 * inputs, password inputs, availability, department, and Arraylist of nurses to
	 * add.
	 */
	...
	/**
	 * verify entered information, store information in database, and return an
	 * appropriate debug message accordingly
	 * 
	 * @author Sajid C
	...
	public String storeInDatabase() {
		...
		Main.dbase.put(username, new DoctorModel(username, pwd, name, department, temp.toArray(new String[0]),
				new String[0], blankLDTAvailability()));
		return "Account successfully created!";
	}

	/**
	 * return the list of nurses names currently in the database, as a String array
