...
/**
 * Parent class to all model classes. Contains ease-of-use functionality and
 * fields common to all 'roles' in the system
 * 
...
public class UserSuperClass {
	...
	protected Schedule s = new Schedule(); // initialize s so now ALL model classes can use object 's' to get
											// ease-of-use functions in Schedule class
	...
	// returns a
	/**
	 * Searches the database for a list of usernames, and returns the names
	...
	/**
	 * convert a date string(uuuu/M/d) to a Unix Time (seconds) string more info:
	...
	public String[] blankAvailability() {
		String[] temp = { "00:00", "00:00", "00:00", "00:00", "00:00", "00:00", "00:00", "00:00", "00:00", "00:00",
