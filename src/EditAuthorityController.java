...
/**
 * MVC Model: Controller that deals with the Edit Authority functionality,
 * interacts with model and view to help edit authority.
 * 
 * @author Jeremy Fan
 */
...
public class EditAuthorityController {
	...
	public EditAuthorityController(EditAuthorityModel model, EditAuthorityPersonalInfoView view2,
	 ...
	 * case, add an action to the "create button".
	 * 
	 ...
	 * initialize the listeners from the view class that need to interact with model
	 * and give functionality to these listeners once they 'hear' something In this
	 * case, add an action to the "get edit information".
	 * 
	 * @author Sajid C, Jeremy F
	 */
	 ...
	 * initialize the listeners from the view class that need to interact with model
	 * and give functionality to these listeners once they 'hear' something In this
	 * case, add an action to the "confirm information".
	 * 
	 * @author Sajid C, Jeremy F
	 */
