...
public class StartScreen extends JFrame {
			...
			public StartScreen(Database dbase) {
						...
						//// Each 'pair' represents each Label and corresponding Text Field for Login Username and Password
						////Pair of Username and Label
			...
			////Also clears the text in case you typed something before
			...
			////These two are vital for receiving login information and comparing
